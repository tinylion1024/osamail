...
OsaMail 0.1.0 has been developed and live-tested against Mail 16.0 on macOS
...
`osamail-v0.1.0-universal-apple-darwin.tar.gz` from the repository's Releases
...
After version 0.1.0 is published to crates.io:
...
Field names form the 0.1.0 machine-readable interface. Optional Mail values may
...
- Version 0.1.0 does not support attachments, reply, forward, delete, move,
